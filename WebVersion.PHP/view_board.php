...
<tr><th>Option</th><th> Student ID</th><th>Club ID</th><th>Semester</th><th> Year</th><th>Ranking</tr>
...
class TableRows extends RecursiveIteratorIterator {
  ...
  function beginChildren() {
     echo "<tr><td style='border:1px solid black;'>
          ...
          <button name='pcode' type='submit' formaction='del_product.php'  value='" . parent::current() .
...
try {
  ...
  $sth = $dbh->prepare("call view_board('".$user."') ");
  $sth->execute();
